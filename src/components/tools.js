        ...
        return(
            <div className="ct-main">
                ...
                <div className="ct-contentAbout">
                    ...
                    The technologies and tools that I have been using for design and development are Adobe Illustrator, Adobe Photoshop, Figma, Adobe XD, Trello, Miró, HTML5, CSS3, Bootstrap, Tailwind, Styled Components, Javascript, Jest, Vue.js, Vuex, React.js, Sass, PHP, Laravel, PHPUnit, Xampp, MySQL, Visual Studio Code, IntelliJ, Composer, Node.js, Java, SpringBoot, Git, Github and more...</p>
                    <Tool/>
                </div>
