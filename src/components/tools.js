        ...
        return(
            <div className="ct-main">
                ...
                <div className="ct-contentAbout">
                    ...
                    The technologies and tools that I have been using for design and development are Adobe Illustrator, Adobe Photoshop, Figma, Trello, Miró, HTML5, CSS3, Bootstrap, Tailwind, Javascript, Jest, Vue.js, Vuex, React.js, Sass, PHP, Laravel, PHPUnit, Xampp, MySQL, Visual Studio Code, Composer, Node.js, Git, Github and more...</p>
                    <Tool/>
                </div>
